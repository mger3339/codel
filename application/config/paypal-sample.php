 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'mger3389-facilitator_api1.gmail.com'                       : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'VR9CKZVEEHT74V57'                                          : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AvZMQ52EdNjniQ3qPDyNTig3JjU9APeVnOcND.Bd3EchrQSIcq5WmNnH' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['PayFlowUsername'] = $config['Sandbox'] ? 'SANDBOX_USERNAME_GOES_HERE' : 'PRODUCTION_USERNAME_GOES_HERE';
