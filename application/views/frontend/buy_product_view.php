...
<!--            --><?php //print_r($shipping); die; ?>
            ...
            <button data-id="<?=$id?>" type="button" class="btn btn-success buy_now" data-dismiss="modal">BUY NOW</button>
            <div class="shipping_div">
                ...
                <div class="shipping_total">
                    ...
                    <button data-id="<?=$item['id'];?>" type="button" class="btn btn-success shipping_price_button"><div class="shipping_price"><?php echo $item['shipping_price']; ?>$</div></button>
                </div>
                <?php endforeach; ?>
            </div>
    </div>
