                ...
                <form action="<?php echo base_url('admin/areas/saveArea'); ?>" class="add_area_form" method="post"
                    ...
                    <div class="form-group coordinates">
                        ...
                        <div class="div_latitude">
                            <input type="text" name="latitude" class="form-control latitude_input" id="latitude"
                        ...
                        <div class="div_longitude">
                            <input type="text" name="longitude" class="form-control longitude_input" id="longitude"
