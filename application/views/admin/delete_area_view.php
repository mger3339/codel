        ...
        <div id="page-inner">
            ...
            <div class="delete_category">
                <?php foreach ($data as $value) : ?>
                    ...
                    <a href="<?php echo base_url('admin/areas/deleteAreaById/'. $value['id']); ?>"><button data-id="<?php echo $value['id']; ?>" type="button" class="btn btn-danger delete_button"><?php echo $value['country']; ?></button>
                <?php endforeach; ?>
            </div>
