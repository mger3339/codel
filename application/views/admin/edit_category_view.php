        ...
        <div id="page-inner">
            ...
            <div class="edit_category">
                <?php foreach ($data as $value) : ?>
                    <button data-id="<?php echo $value['id']; ?>" type="button" class="btn btn-primary edit_button"><?php echo $value['category_name']; ?></button>
                <?php endforeach; ?>
            </div>
            <div class="category_edit">
                <form action="<?php echo base_url('admin/categories/saveCategory'); ?>" method="post" class="edit_category_form" enctype="multipart/form-data">
                    <input type="hidden" name="hidden_id_category" class="hidden_id" value="">
                    <div class="form-group">
                        <label for="edit_category">Enter Product category</label>
                        <input type="text" name="category_name" value="" class="form-control add_input" id="edit_category"  placeholder="Name Product"><div class="country_name_error"></div>
                    </div>
