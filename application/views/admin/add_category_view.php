...
<div id="wrapper">
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            <div class="category">
                <form action="<?php echo base_url('admin/categories/saveCategory'); ?>" method="post" class="add_category_form" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="add_category">Enter Product category</label>
                        <input type="text" name="category_name" class="form-control add_input" id="add_category"  placeholder="Name Product"><div class="country_name_error"></div>
                    </div>
