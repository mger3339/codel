        ...
        <div id="page-inner">
            ...
            <div class="delete_category">
                    <?php foreach ($category as $value) : ?>
                        <a href="<?php echo base_url('admin/categories/deleteCategoryById/' . $value['id']); ?>"><button type="button" class="btn btn-danger delete_category_button"><?php echo $value['category_name']; ?></button></a>
                    <?php endforeach; ?>
            </div>
        </div>
    </div>
