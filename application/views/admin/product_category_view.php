                ...
                <div class="product_<?= $id ?>">
                    <div class="div_product">
                        ...
                        <a href="<?php echo base_url('index.php/admin/products/editProduct/' . $id); ?>">
                            <button class="btn btn-success btn-lg admin_edit_button"><span class="edit">EDIT</span>
                            </button>
                        </a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="<?php echo base_url('index.php/admin/categories/deleteProduct/' . $id); ?>">
                                    <button data-id="<?= $id ?>" type="button" class="btn btn-danger delete_category"
