...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="slider_image_view">
            <img src="<?php echo base_url('assets/img_slider/' . $images['0']['img']); ?>" width="100%">
        </div>
        <div class="add_image_slider_div">
            <form action="<?php echo base_url('admin/slider/editImage/' . $images['0']['id']); ?>" method="post"
                  enctype="multipart/form-data">
                <div class="input-group div_file">
                    <span class="input-group-btn">
                        <span class="btn btn-primary btn-file">
                            Browse&hellip; <input type="file" name="userfile" id="exampleInputFile"
                                                  value="<?php echo $images['0']['img']; ?>">
                        </span>
                    </span>
