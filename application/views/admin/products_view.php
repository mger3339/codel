...
<div id="wrapper">
    <div id="page-wrapper" >
        <div id="page-inner">
            <div id="add_button">
                <a href="<?php echo base_url('index.php/admin/products/addProduct');?>"><button class="btn btn-info">ADD PRODUCT</button></a>
            </div>
            <div class="info"></div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="<?php echo base_url('index.php/admin/products');?>"><button type="button" class="btn btn-success" data-dismiss="modal">NO</button></a>
                            <a href="<?php echo base_url('index.php/admin/products/deleteProduct/' .$id);?>"><button data-id="<?=$id?>" type="button" class="btn btn-danger delete" data-dismiss="modal">YES</button></a>
                        </div>
                    </div>
                </div>
            </div>
